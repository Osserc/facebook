...
# 8
  ...
  has_many :initiated_friendships, class_name: "Friendship", foreign_key: :friend_one_id, dependent: :destroy
  has_many :befriendeds, through: :initiated_friendships, source: :friend_two

  has_many :received_friendships, class_name: "Friendship", foreign_key: :friend_two_id, dependent: :destroy
  has_many :befriended_bys, through: :received_friendships, source: :friend_one

  has_many :followed_people, class_name: "Following", foreign_key: :follower_id, dependent: :destroy
  has_many :follows, through: :followed_people, source: :follow

  has_many :following_people, class_name: "Following", foreign_key: :follow_id, dependent: :destroy
  has_many :followers, through: :following_people, source: :follower

  has_many :blocked_people, class_name: "Blocking", foreign_key: :blocker_id, dependent: :destroy
  has_many :blockeds, through: :blocked_people, source: :blocked

  has_many :blocked_by, class_name: "Blocking", foreign_key: :blocked_id, dependent: :destroy
  has_many :blockers, through: :blocked_by, source: :blocker

  has_many :notifications, foreign_key: :receiver_id, dependent: :destroy
  has_many :issued_notifications, class_name: "Notification", foreign_key: :issuer_id, dependent: :destroy
